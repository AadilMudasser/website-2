...
function directBookingProps(className, label) {
  return {
    className,
...
const navItems = [
  ...
  ["Blog", "#/blog"],
  ["Book Consultation", PRACTICE_BETTER_BOOKING_URL],
];
...
const weightLossPackageData = [
  {
    name: "Silver",
    monthlyPrice: "34,999 PKR",
    initialCost: "44,999 PKR",
    tone: "silver",
    summary: "A calm starting point with guided reviews and essential support.",
    items: [
  ...
  },
  {
    ...
    featured: true,
    tone: "gold",
    summary: "Balanced ongoing support with more frequent review and deeper testing.",
    items: [
      "Initial consultation",
  ...
  },
  {
    ...
    tone: "platinum",
    summary: "A more comprehensive, high-touch package with multidisciplinary support.",
    items: [
      "Initial consultation",
...
function App() {
  ...
  const page = useMemo(() => {
    ...
    if (route === weightLossFormConfig.route) return h(BookingRedirectPage);
    if (route === womensHealthFormConfig.route) return h(BookingRedirectPage);
    if (route === aestheticsFormConfig.route) return h(BookingRedirectPage);
    if (route === "/book") return h(BookingRedirectPage);
    return h(HomePage);
  }, [route]);
...
function Header({ route }) {
  ...
  return h(
    ...
    h(
      ...
      h(Img, { className: "brand-logo", src: siteLogo, alt: "AQ Wellness logo" }),
      h("span", { className: "brand-name" }, SITE_NAME)
    ),
    h(
      "button",
      {
  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        h("a", directBookingProps("button primary", "Book Consultation"), "Book Consultation"),
        h(
          "div",
...
function HomePackagesPreview() {
  return h(
    "section",
    { className: "packages-preview section-shell reveal" },
    h(
      "div",
      { className: "split-heading" },
      h("div", null, h("p", { className: "eyebrow" }, "Weight Loss Packages"), h("h2", null, "A clear path with flexible levels of support")),
      h("a", { className: "button primary", href: "#/weight-loss" }, "View Weight Loss Packages")
    ),
    h(
      "div",
      { className: "packages-preview-grid" },
      weightLossPackageData.map((plan) =>
        h(
          "article",
          { className: `package-card package-preview-card package-${plan.tone} ${plan.featured ? "is-featured" : ""}`, key: plan.name },
          plan.badge && h("span", { className: "package-badge" }, plan.badge),
          h("h3", null, plan.name),
          h(
            "div",
            { className: "package-pricing" },
            h("p", { className: "package-price" }, h("span", null, plan.monthlyPrice), h("small", null, "/month")),
            h("p", { className: "package-initial" }, `Initial setup: ${plan.initialCost}`)
          ),
          h("p", { className: "package-summary" }, plan.summary),
          h("a", { className: "button booking-button", href: "#/weight-loss" }, "Go To Packages")
        )
      )
    )
  );
...
function HowItWorks() {
  ...
  return h(
    ...
    h(
      ...
      h("a", directBookingProps("button primary timeline-cta", "Start Your Journey"), "Start Your Journey")
    )
  );
}
...
function FinalBookingBand() {
  return h(
    "section",
    { className: "final-booking-band section-shell reveal" },
    h("p", { className: "eyebrow" }, "Private Booking"),
    h("h2", null, "Ready to speak with Dr. Alia?"),
    h("p", null, "Choose a consultation time directly and keep the next step simple, private, and immediate."),
    h(
      "div",
      { className: "booking-band-actions" },
      h("a", directBookingProps("button primary", "Speak With Dr. Alia"), "Speak With Dr. Alia"),
      h("a", { className: "button booking-button", href: "#/weight-loss" }, "View Weight Loss Packages")
    )
  );
}
...
function FinalCta() {
  return h(
    ...
    h(
      ...
      h("a", directBookingProps("button light", "Start Your Journey"), "Start Your Journey")
    )
  );
}
...
function BookingRedirectPage() {
  useEffect(() => {
    window.location.replace(PRACTICE_BETTER_BOOKING_URL);
  }, []);
  ...
  return h(
    ...
    h(
      ...
      h("p", { className: "eyebrow" }, "Booking"),
      h("h1", null, "Redirecting to booking"),
      h("p", null, "Taking you straight to the booking calendar now."),
      h("a", directBookingProps("button primary", "Book Consultation"), "Book Consultation")
    )
  );
}
      ...
      moreServiceGroups.map((group, index) =>
        h(
          ...
          h(
            ...
            h("a", directBookingProps("button booking-button service-direct-book", "Book Consultation"), "Book Consultation"),
            h(
              "div",
              ...
              group.subs.map((sub) =>
                h(
                  "button",
                  {
                    type: "button",
                    key: sub,
                    onClick: () => setModal({ group: group.title, sub, bookingHref: PRACTICE_BETTER_BOOKING_URL }),
                  },
                  sub
                )
              )
    ...
    h(
      ...
      packages.map((plan) =>
        h(
          ...
          h("a", directBookingProps("button booking-button", "Book Consultation"), "Book Consultation")
        )
      )
    ),
    h(
...
function WeightLossPage() {
  return h(
    ...
    h(FocusSection, {
      ...
      image: images.weight,
      cta: "Speak With Dr. Alia",
      href: PRACTICE_BETTER_BOOKING_URL,
      bookingHref: PRACTICE_BETTER_BOOKING_URL,
...
function PageHero({ title, text }) {
  return h(
    ...
    h("p", { className: "eyebrow" }, SITE_NAME),
    h("h1", null, title),
    h("p", null, text)
  );
}
...
function Footer() {
  return h(
    ...
    h(
      ...
      null,
      h("h2", null, SITE_NAME),
      h("p", null, "UK Certified. Dubai Experienced. Personalized private care.")
    ),
    h(
      "div",
