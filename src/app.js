...
const FORM_ENDPOINTS = {
  weightLoss: "https://formspree.io/f/meeneqpl",
  womensHealth: "https://formspree.io/f/mqeneknp",
};
...
const weightLossFormConfig = {
  ...
  endpoint: FORM_ENDPOINTS.weightLoss,
  service: "Weight Loss",
  ...
  steps: [
    ...
    {
      title: "Your symptoms",
      fields: ["symptoms", "lifestyleRating"],
    },
    {
      title: "Your contact details",
      fields: ["mainChallenge", "name", "phone", "email"],
    },
  ],
};
...
const womensHealthFormConfig = {
  ...
  endpoint: FORM_ENDPOINTS.womensHealth,
  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        h(BookChoiceCard, {
          title: "Mental Health, Preventive Medicine, and Dermatology & Skincare",
...
function ServiceFormPage({ config }) {
  ...
  const isWeightLoss = config.service === "Weight Loss";
      ...
      return h(
        ...
        h(FieldBlock, {
          ...
          content: h(ChoiceGrid, {
            options: ["Fat loss", "Metabolic support", "Long-term maintenance", "Treatment guidance"],
            value: data.mainGoal,
            onChange: (value) => updateField("mainGoal", value),
          }),
        }),
        h(FieldBlock, {
          label: "Target weight loss range",
          content: h(ChoiceGrid, {
      ...
      return h(
        ...
        h(FieldBlock, {
          ...
          content: h("textarea", {
            ...
            placeholder: "Tell us what you have already tried.",
          }),
        })
      );
    }
      ...
      return h(
        ...
        h(FieldBlock, {
          ...
          content: h(MultiSelectGrid, {
            options: ["Low energy", "Emotional eating", "Slow metabolism", "Hormonal issues"],
            values: data.symptoms,
            onToggle: (value) => toggleMulti("symptoms", value),
          }),
        }),
        h(FieldBlock, {
          label: "Lifestyle rating",
          content: h(ScaleField, {
            labels: ["Low", "Below Average", "Moderate", "Strong", "Excellent"],
            value: data.lifestyleRating,
            onChange: (value) => updateField("lifestyleRating", value),
          }),
        })
      );
    }
      ...
      moreServiceGroups.map((group, index) =>
        h(
          ...
          h(
            ...
            h("a", { className: "button booking-button service-direct-book", href: PRACTICE_BETTER_BOOKING_URL, rel: "noreferrer" }, "Book Now"),
            h(
              "div",
              ...
              group.subs.map((sub) =>
                h(
                  "button",
                  {
                    type: "button",
                    key: sub,
                    onClick: () => setModal({ group: group.title, sub, bookingHref: "" }),
                  },
                  sub
                )
              )
